  ...
  <body class="login" >
    <div>
      ...
      <div class="d-none d-md-block col-md-6" >
        <div  style="background: url(<?php echo ROUTE_URL; ?>img/login/pacientes.jpg);background-size: cover;height: 100vh;width: 100%;"></div>
    </div>
        ...
        <div class="login_wrapper">
          <div class="animate form login_form">
            <section class="login_content">
              ...
              <form id="login" role="form" onsubmit="pacientes('<?php echo ROUTE_URL; ?>login/sesion');return false">
                <h2>Resultados en Línea</h2>
                <h1 class="title-login">PACIENTES</h1>
                <p>Acceder  a la plataforma con tu cuenta de usuario</p>
                <div id="alertLogin"></div>
                <div>
                  <input type="number" class="form-control" placeholder="DNI" id="dni" name="dni" required="" style="width: 100%" />
                </div>
                <div>
